      ...
      <div className="productDescriptionContainer">
        <div className="flexRow">
          ...
          <div className="productDescContainer">
            ...
            {/* action buttons */}
            <div className="flexRow">
              {product.productDetails.en_stock ? (
                <>
                  <MaterialButton
                    title="ADD TO CART"
                    bgColor="#ff9f00"
                    ...
                    icon={<IoMdCart />}
                    onClick={() => {
                      const { _id, libelle, prix_ttc, is_gift, en_stock } =
                        product.productDetails;

                      dispatch(
                        addToCart({ _id, libelle, prix_ttc, is_gift, en_stock })
                      );
        ...
        <div>
          <div className="productDetails">
            ...
            <div className="extraOffer">Extra product </div>
            <div className="flexRow priceContainer">
              <span className="price">{product.productDetails.prix_ttc}DT</span>
              {product.productDetails.is_gift ? (
                <span className="discount" style={{ margin: "0 10px" }}>
                  70% after discount({product.productDetails.prix_ttc * 0.3}DT)
                </span>
              ) : (
                <span className="discount" style={{ margin: "0 10px" }}>
                  {product.productDetails.prix_ttc - giftVlue}DT
                </span>
              )}
            </div>
            <div>
